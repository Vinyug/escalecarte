...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.carte.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.cartes.update", [$carte->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="ref">{{ trans('cruds.carte.fields.ref') }}</label>
                <input class="form-control {{ $errors->has('ref') ? 'is-invalid' : '' }}" type="text" name="ref" id="ref" value="{{ old('ref', $carte->ref) }}" required>
                @if($errors->has('ref'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('montant') ? 'is-invalid' : '' }}" type="number" name="montant" id="montant" value="{{ old('montant', $carte->montant) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aprenom') ? 'is-invalid' : '' }}" type="text" name="aprenom" id="aprenom" value="{{ old('aprenom', $carte->aprenom) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('anom') ? 'is-invalid' : '' }}" type="text" name="anom" id="anom" value="{{ old('anom', $carte->anom) }}" required>
                @if($errors->has('anom'))
                    <div class="invalid-feedback">
                        {{ $errors->first('anom') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amail') ? 'is-invalid' : '' }}" type="text" name="amail" id="amail" value="{{ old('amail', $carte->amail) }}" required>
                @if($errors->has('amail'))
                    <div class="invalid-feedback">
                        {{ $errors->first('amail') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('amsg') ? 'is-invalid' : '' }}" name="amsg" id="amsg">{!! old('amsg', $carte->amsg) !!}</textarea>
                @if($errors->has('amsg'))
                    <div class="invalid-feedback">
                        {{ $errors->first('amsg') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deprenom') ? 'is-invalid' : '' }}" type="text" name="deprenom" id="deprenom" value="{{ old('deprenom', $carte->deprenom) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('denom') ? 'is-invalid' : '' }}" type="text" name="denom" id="denom" value="{{ old('denom', $carte->denom) }}" required>
                @if($errors->has('denom'))
                    <div class="invalid-feedback">
                        {{ $errors->first('denom') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('demail') ? 'is-invalid' : '' }}" type="text" name="demail" id="demail" value="{{ old('demail', $carte->demail) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('institut') ? 'is-invalid' : '' }}" name="institut_id" id="institut_id" required>
                    @foreach($instituts as $id => $entry)
                        <option value="{{ $id }}" {{ (old('institut_id') ? old('institut_id') : $carte->institut->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stripeid') ? 'is-invalid' : '' }}" type="text" name="stripeid" id="stripeid" value="{{ old('stripeid', $carte->stripeid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statut') ? 'is-invalid' : '' }}" type="text" name="statut" id="statut" value="{{ old('statut', $carte->statut) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('use') ? 'is-invalid' : '' }}" type="text" name="use" id="use" value="{{ old('use', $carte->use) }}">
                @if($errors->has('use'))
                    <div class="invalid-feedback">
                        {{ $errors->first('use') }}
                    </div>
